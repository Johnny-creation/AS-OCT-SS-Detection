...
def main():
    ...
    print("  训练集: ~574 张 (80%)")
    print("  验证集: ~143 张 (20%)")
    print("  类别: 1 (asoct - 合并所有原始类别)")
    print("  关键点: 2 (left_scleral_spur, right_scleral_spur)")

    print("\n原始类别分布:")
    print("  Cataract: 380 张 (53.0%)")
    print("  Normal: 50 张 (7.0%)")
    print("  PACG: 148 张 (20.6%)")
    print("  PACG_Cataract: 139 张 (19.4%)")
